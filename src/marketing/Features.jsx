...
const FEATURES = [
  {
    ...
    items: [
      { icon: '📢', title: 'Parish Feed', desc: 'Announcements, posts, and updates from your parish.' },
      ...
      { icon: '🔔', title: 'Push Notifications', desc: 'Push notifications for announcements and events.' },
      { icon: '⛪', title: 'Parish Directory', desc: '559 verified Massachusetts parishes in directory.' },
      { icon: '🔗', title: 'Parish Clusters', desc: 'Multiple parishes under one pastoral name (e.g. Carlo Acutis Parish) shown together.' },
    ],
  },
  {
    category: 'Community',
  ...
  },
  {
    ...
    items: [
      { icon: '📖', title: 'Daily Readings', desc: 'Full USCCB Mass readings, liturgical season, and calendar.' },
      ...
      { icon: '🪞', title: 'Examination of Conscience', desc: 'A guided examination across all Ten Commandments and the Precepts of the Church to prepare well for Confession.' },
      { icon: '🛡️', title: 'Confession Tracker', desc: 'Track your last confession and how many days it\'s been. Completely private.' },
      { icon: '📔', title: 'Prayer Journal', desc: 'A private space to keep track of your intentions and reflections.' },
    ],
  },
  {
    ...
    items: [
      ...
      { icon: '📣', title: 'Announcements', desc: 'Post announcements that reach every follower directly with no algorithm filter.' },
      { icon: '🗓️', title: 'Event Management', desc: 'Create events, track RSVPs, and view attendee breakdowns.' },
      { icon: '⏱️', title: 'Scheduled Posts', desc: 'Write posts in advance and schedule them to publish automatically.' },
      { icon: '🏘️', title: 'Multi-Parish Clergy', desc: 'Pastors serving multiple parishes can be set as admin of each one.' },
      { icon: '🔁', title: 'Platform Integrations', desc: 'Auto-post announcements to Facebook, Flocknote, and your website the moment you publish.' },
    ],
  },
  {
    category: 'Platform',
