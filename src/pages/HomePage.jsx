      ...
      <div className="max-w-2xl mx-auto px-4 pt-5 pb-24 flex flex-col gap-4">
        ...
        {parish ? (
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4">
            ...
            <p className="text-xs text-gray-400 italic mt-3 pl-13">Parish posts will appear here soon.</p>
          </div>
        ) : (
        ...
        {groups.length > 0 ? (
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 text-center">
            ...
            <p className="text-gray-500 text-xs mb-2">
              Join a group to connect with Catholics who share your vocation and interests.
            </p>
            <Link to="/groups" className="text-sm text-navy font-semibold hover:underline">
              Browse groups →
            </Link>
          </div>
        )}
        ...
        <div className="text-center py-4">
          <p className="text-xs text-gray-400">Community posts are coming soon. For now, explore your parish and groups.</p>
        </div>
